<template>
    <div class="rewards-code">
        <div class="code-inner">
            ...
            <div class="inner-info">Start your journey on TheLuckyBet with a little bonus! Redeem a code to earn a free 10 DL.</div>
            <div class="inner-input">
                ...
                <div class="input-info">
                    Don't have a code? Use code <span>LuckyBet</span>
                </div>
            </div>
        </div>
    </div>
