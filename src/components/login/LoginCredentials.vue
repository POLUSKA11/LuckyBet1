<template>
    ...
    <div class="login-credentials">
        ...
        <div class="credentials-info">
            By accessing theluckybet.xyz, I attest that I am at least 18 years old and have read and agree with the <button v-on:click="loginTermsButton()" class="button-terms">Terms of Service</button>.
        </div>
