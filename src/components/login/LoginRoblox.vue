<template>
    <div class="login-roblox">
        ...
        <div class="roblox-info">
            By accessing TheLuckyBet.com, I attest that I am at least 18 years old and have read and agree with the <button v-on:click="loginTermsButton()" class="button-terms">Terms of Service</button>.
        </div>
