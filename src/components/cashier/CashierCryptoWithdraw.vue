<template>
    <div class="cashier-crypto-withdraw">
        <div class="withdraw-amount">
            ...
            <p>Enter the amount of DL you would like to withdraw. The network fees will be deducted from your withdraw amount. Average network fees are <span>${{ modalFormatValue(cashierGetFee) }}</span>.</p>
