    ...
    <footer id="footer">
        <div class="footer-top">
            <div class="top-info">
                ...
                <div class="info-text">
                    TheLuckyBet.xyz Best gambling website of gtps.
                    <span class="gradient-green">Developed By FocusedOVP</span>
                </div>
            </div>
            <div class="top-links">
                ...
                <div class="links-section">
                    ...
                    <a href="https://discord.gg/" target="_blank">Support</a>
        ...
        <div class="footer-bottom">
            <span class="gradient-green">LuckyBet Developers</span><br>
            <span class="gradient-green">DC: FocusedOVP</span><br>
        </div>
    </footer>
</template>
