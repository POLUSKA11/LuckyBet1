<template>
    <div class="modal-robux">
        ...
        <div class="robux-title">
            <span class="gradient-green">{{modalsData.typeCashier}} DL</span>
        </div>
        <div class="robux-amount">
            <input v-model="modalAmount" v-on:input="modalValidateInput()" type="text" placeholder="AMOUNT OF DL" />
        ...
        <div class="robux-info">
            <div v-if="modalsData.typeCashier === 'deposit'" class="info-deposit">
                Enter your desired DLS amount that you want to deposit. Make sure the amount doesn’t exceed your DL balance of your Growtopia Account.
            </div>
