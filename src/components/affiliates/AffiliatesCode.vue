        ...
        <div class="code-inner">
            <div class="inner-info">
                <div class="info-text">
                    ...
                    <div class="text-link">
                        http://theluckybet.xyz/?a={{ affiliatesData.data !== null && affiliatesData.data.code !== undefined ? affiliatesData.data.code : '' }}
    ...
    export default {
       ...
       methods: {
            ...
            affiliatesCopyButton() {
                ...
                el.value = ' http://theluckybet.xyz/?a=' + (this.affiliatesData.data !== null && this.affiliatesData.data.code !== undefined ? this.affiliatesData.data.code : '');
